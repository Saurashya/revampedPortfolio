...
export default function Landing() {
    return (
        <div className="relative h-screen overflow-hidden p-8">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 mt-8 leading-[14vw] lg:leading-[10vw] 2xl:leading-[9rem] font-medium h-[40rem] tracking-[-.3rem]">
            ...
            <MagneticWrapper className="absolute left-1/2 -translate-x-1/2 bottom-[8rem] 2xl:-bottom-10 md:bottom-[4rem]">
                <ScrollDown/>
            </MagneticWrapper>
